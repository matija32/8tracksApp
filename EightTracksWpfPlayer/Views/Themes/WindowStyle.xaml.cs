...
namespace EightTracksWpfPlayer.Views.Themes
{
    public partial class WindowCustomBorderStyle : ResourceDictionary
    {
        public WindowCustomBorderStyle()
        {
            ...
            if (vs.Major <= 5)
            {
                osDependantResources.Source = new Uri("/Views/Themes/WindowStyleXP.xaml", UriKind.Relative);
            }
            else
            {
                osDependantResources.Source = new Uri("/Views/Themes/WindowStyleWin7.xaml", UriKind.Relative);
            }
        ...
        private void OnThemeSelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            if (e.AddedItems.Count > 0)
            {
                ...
                skin.Source = new Uri(@"Views\Themes\Skins\" + themeXamlFileName + ".xaml", UriKind.Relative);
